# Model card: transformer_distilbert-base-uncased_v1 (urgency)
...
- Macro-F1: **0.9074** (baseline `baseline_linear_svc_v1`: 0.7944)
...
|---|---|---|
| p50 latency (single request) | 12.1 ms | 1.6 ms |
| p95 latency | 13.7 ms | 1.7 ms |
| Export size | 256.3 MB | 3.5 MB |
