...
# Only fall back to app settings when the caller hasn't already configured a
# url (e.g. a test pointing this at an ephemeral testcontainer) — otherwise
# this would silently redirect every programmatic invocation back to the
# dev database.
