"""Trains TF-IDF + LogisticRegression/LinearSVC baselines for emotion
classification (SPEC M5, CLAUDE.md rule #2: every learned component gets a
classical baseline before the transformer). 4-class: anger/joy/optimism/
sadness, transferred from tweet_eval (ml/training/tweet_eval_data.py).

Run: uv run python -m ml.training.train_baseline_emotion
"""
