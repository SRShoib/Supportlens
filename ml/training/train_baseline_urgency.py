"""Trains TF-IDF + LogisticRegression/LinearSVC baselines for urgency
classification on weak labels (SPEC M2). Urgency has no ground truth — this
is a weak-supervision showcase (see ml/evaluation/kappa.py for the LLM-seed
agreement report), not a macro-F1 accept gate.

Run: uv run python -m ml.training.train_baseline_urgency
"""
