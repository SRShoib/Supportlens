"""Trains TF-IDF + LogisticRegression/LinearSVC baselines for sentiment
classification (SPEC M5, CLAUDE.md rule #2: every learned component gets a
classical baseline before the transformer). 3-class: negative/neutral/
positive, transferred from tweet_eval (ml/training/tweet_eval_data.py).

Run: uv run python -m ml.training.train_baseline_sentiment
"""
...
TASK = "sentiment"
DATASET = "tweet_eval_sentiment_v1"
